	...
	var servents = {
		'saber': [2, 8, 68, 76, 90, 91, 153, 160, 213, 234, 270, 278, 299, 302, 317, 337, 343],
		'archer': [12, 60, 77, 84, 129, 142, 156, 212, 216, 272, 276, 350],
		'lancer': [70, 85, 88, 119, 128, 143, 196, 232, 280, 300, 312, 329, 368],
		...
		'assassin': [75, 86, 112, 139, 154, 189, 199, 235, 239, 314, 365],
		'berserker': [51, 52, 97, 98, 114, 155, 161, 226, 247, 261, 306, 309, 355, 362],
		'ruler': [59, 93, 173, 229, 265, 292, 305, 346, 357],
		'avenger': [96, 106, 250, 268, 303, 321],
		'alterego': [163, 167, 209, 224, 238, 297, 336, 339],
		'foreigner': [195, 198, 275, 281, 289, 295, 324, 334],
	...
	*/
	...
	assassin:[285, 275, 268, 321, 285, 198],
	...
	for (i = 0; i < CategoryLen; i++) {
		...
		for (j = 0; j < servents[Category[i]].length; j++) {
			...
			// units[i][j] = new Unit("servents/" + no + ".png");
